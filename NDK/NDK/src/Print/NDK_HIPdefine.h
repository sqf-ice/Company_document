#ifndef _NDK_HIPDEFINE_H_
#define _NDK_HIPDEFINE_H_
...
#define nlmain main(int argc, char *argv[]) \
	{ int ret; ndk_config_init(); ret=_nlmain(); ndk_config_exit(); return ret;} int _nlmain
...
//    IME_PINYIN,// 全拼
    ...
    IME_QUWEI,// 区位
	IME_BIHUA,
    IME_MAXNUM=IME_BIHUA,//仅用于错误判断
    IME_LAST_ONE=100//和前次一样
};
#endif
